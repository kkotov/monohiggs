...
Mono-higgs cross section: $\sigma(pp > h~ chi~ chi\tilde~ ) = 0.126~pb$ (independent on $m_S$)

Invisible cross section: $\sigma(pp~ >~ chi~ chi\tilde~ ) = 350~pb~$ (independent on $m_S$)
...
r <- rbind(r, data.frame(mass=c(200), rate=c(0.00622), process='invisible') )
r <- rbind(r, data.frame(mass=c(200), rate=c(0.000498), process='mono-H') )
r <- rbind(r, data.frame(mass=c(300), rate=c(0.00513), process='invisible') )
r <- rbind(r, data.frame(mass=c(300), rate=c(0.0012), process='mono-H') )
r <- rbind(r, data.frame(mass=c(400), rate=c(0.00366), process='invisible') )
r <- rbind(r, data.frame(mass=c(400), rate=c(0.0015), process='mono-H') )
r <- rbind(r, data.frame(mass=c(500), rate=c(0.00292), process='invisible') )
r <- rbind(r, data.frame(mass=c(500), rate=c(0.00166), process='mono-H') )
r <- rbind(r, data.frame(mass=c(600), rate=c(0.00255), process='invisible') )
r <- rbind(r, data.frame(mass=c(600), rate=c(0.00174), process='mono-H') )
r <- rbind(r, data.frame(mass=c(700), rate=c(0.00235), process='invisible') )
r <- rbind(r, data.frame(mass=c(700), rate=c(0.00173), process='mono-H') )
r <- rbind(r, data.frame(mass=c(800), rate=c(0.00224), process='invisible') )
r <- rbind(r, data.frame(mass=c(800), rate=c(0.00168), process='mono-H') )
...
<img class=center src="hmAllSelWide.svg" height=450>
...
<img class=center src="hmCSelWide.svg" height=450>

*** =right

<img class=center src="hmCAllSelWide.svg" height=450>
...
<img class=center src="allVSsig.svg" height=450>
